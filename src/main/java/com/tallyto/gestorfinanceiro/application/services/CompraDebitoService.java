...
import com.tallyto.gestorfinanceiro.infrastructure.repositories.CompraDebitoRepository;
...
public class CompraDebitoService {
    ...
    public CompraDebito salvarCompraDebito(CompraDebito compraDebito) {
        ...
        var transacaoDTO = new com.tallyto.gestorfinanceiro.web.api.dto.TransacaoInputDTO(
            com.tallyto.gestorfinanceiro.domain.enums.TipoTransacao.DEBITO,
