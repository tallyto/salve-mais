...
import com.tallyto.gestorfinanceiro.web.api.dto.TransacaoDTO;
import com.tallyto.gestorfinanceiro.web.api.dto.TransacaoFiltroDTO;
import com.tallyto.gestorfinanceiro.web.api.dto.TransacaoInputDTO;
import com.tallyto.gestorfinanceiro.domain.entities.Categoria;
...
import com.tallyto.gestorfinanceiro.domain.entities.Provento;
...
import com.tallyto.gestorfinanceiro.infrastructure.repositories.CategoriaRepository;
...
import com.tallyto.gestorfinanceiro.infrastructure.repositories.ProventoRepository;
...
public class TransacaoService {
    ...
    public Page<TransacaoDTO> listarTransacoes(TransacaoFiltroDTO filtro, Pageable pageable) {
        return transacaoRepository.findAll(
            com.tallyto.gestorfinanceiro.infrastructure.repositories.specifications.TransacaoSpecification.comFiltro(filtro),
            pageable
        ).map(this::toDTO);
    }
